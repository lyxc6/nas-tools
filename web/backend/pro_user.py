...
SERVICE_CONF = {
    "rssdownload": {
        "name": "电影/电视剧订阅",
        "svg": '<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-cloud-download" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">\n                         <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>\n                         <path d="M19 18a3.5 3.5 0 0 0 0 -7h-1a5 4.5 0 0 0 -11 -2a4.6 4.4 0 0 0 -2.1 8.4"></path>\n                         <line x1="12" y1="13" x2="12" y2="22"></line>\n                         <polyline points="9 19 12 22 15 19"></polyline>\n                    </svg>',
        "color": "blue",
        "level": 2,
    },
    ...
    "blacklist": {
        ...
        "time": "手动",
        "state": "OFF",
        "svg": '<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-eraser" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">\n                       <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>\n                       <path d="M19 20h-10.5l-4.21 -4.3a1 1 0 0 1 0 -1.41l10 -10a1 1 0 0 1 1.41 0l5 5a1 1 0 0 1 0 1.41l-9.2 9.3"></path>\n                       <path d="M18 13.3l-6.3 -6.3"></path>\n                    </svg>',
        "color": "red",
        "level": 1,
    },
    "rsshistory": {
    ...
    "ruletest": {
        ...
        "time": "",
        "state": "OFF",
        "svg": '<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-adjustments-horizontal" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">\n                       <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>\n                       <circle cx="14" cy="6" r="2"></circle>\n                       <line x1="4" y1="6" x2="12" y2="6"></line>\n                       <line x1="16" y1="6" x2="20" y2="6"></line>\n                       <circle cx="8" cy="12" r="2"></circle>\n                       <line x1="4" y1="12" x2="6" y2="12"></line>\n                       <line x1="10" y1="12" x2="20" y2="12"></line>\n                       <circle cx="17" cy="18" r="2"></circle>\n                       <line x1="4" y1="18" x2="15" y2="18"></line>\n                       <line x1="19" y1="18" x2="20" y2="18"></line>\n                    </svg>',
        "color": "yellow",
        "level": 2,
    },
    "nettest": {
...
class ProUser(UserMixin):
    ...
    def __init__(self, user=None):
        ...
        user_sites, public_sites, brush_conf = self.__parse_users_sites(
            Config().get_user_sites_bin_path()
        )
    ...
    def get_usermenus(self, ignore=None):
        """
        获取用户菜单，忽略指定页面
        :param ignore: 要忽略的页面列表
        :return: 用户菜单列表
        """
        user_pris_list = self.get_pris().split(",") # 获取用户权限列表并分割成单个权限
        for menu_key, menu_value in MENU_CONF.items():
            if menu_value.get("page", "null") in ignore:    # 如果菜单页面在忽略列表中，移除该菜单
                MENU_CONF.pop(menu_key)
            for index, page in enumerate(menu_value.get("list", [])):
                if page["page"] in ignore:  # 如果页面在忽略列表中，从菜单列表中移除该页面
                    MENU_CONF[menu_key]["list"].pop(index)

        menu_list = list(itemgetter(*user_pris_list)(MENU_CONF))    # 根据用户权限获取菜单列表
        return menu_list    # 返回用户菜单列表
...
----------------------------------------------------------------------------------------------------------
    ...
    def get_indexer(
        ...
        for item in indexer_list:
            if "domain" in item:
                ...
                if (
                    StringUtils.is_string_and_not_empty(indexer_domain)
                    and domain == indexer_domain
                ):
                    indexer = item
    ...
    def get_public_sites(self):
        ...
        _, public_sites, _ = self.__parse_users_sites(
            Config().get_user_sites_bin_path()
        )
        return public_sites
